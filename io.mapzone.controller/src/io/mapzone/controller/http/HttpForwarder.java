...
public class HttpForwarder
    ...
    protected static final String ATTR_TARGET_URI   = HttpForwarder.class.getSimpleName() + ".targetUri";

    protected static final String ATTR_TARGET_HOST  = HttpForwarder.class.getSimpleName() + ".targetHost";
