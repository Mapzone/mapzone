...
public class HttpForwardServlet
        extends HttpServlet {
    ...
    protected static final String ATTR_TARGET_URI   = HttpForwardServlet.class.getSimpleName() + ".targetUri";

    protected static final String ATTR_TARGET_HOST  = HttpForwardServlet.class.getSimpleName() + ".targetHost";
    ...
    protected void copyProxyCookie( HttpServletRequest servletRequest, HttpServletResponse servletResponse,
        ...
        String path = servletRequest.getContextPath(); // path starts with / or is
                                                       // empty string
        path += servletRequest.getServletPath(); // servlet path starts with / or is
                                                 // empty string
