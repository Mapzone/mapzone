    ...
    public void addFeatures( FeatureCollection featureCollection ) throws Exception {
        ...
        while (iterator.hasNext() && i < 5000) {
            ...
            if (organisationFeature == null) {
                ...
                // add weight
                organisationFeature.style
                        .set( organisationStyle( organisation2Persons.get( organisationFeature ).size() + 1 ) );
            ...
            if (personFeature == null) {
                ...
                personFeature.style.set( personStyle( person2Organisations.get( personFeature ).size() + 1 ) );
                graph.addOrUpdateNode( personFeature, 1 );
            }
        ...
        log.info( organisations.size() + " orgs, " + persons.size() + " persons, " + organisation2Persons.size() + " egdes" );
        organisations.clear();
        persons.clear();
